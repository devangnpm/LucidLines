...
export default function Sidebar() {
  return (
    <div
      className="fixed left-0  top-8 h-full w-64  mt-9  bg-zinc-700 text-white z-50 font-mono text-lg
    border-r"
    >
      <div className="flex flex-col items-center gap-5 space-y-5 ">
        ...
        <div className="flex hover:border gap-2 justify-center w-full p-3 pl-3  hover:bg-green-200 hover:text-black">
